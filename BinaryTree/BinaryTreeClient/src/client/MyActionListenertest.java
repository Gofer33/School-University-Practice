 ...
 * @version 0.99
 */
public class MyActionListenertest implements ActionListener {
	 ...
	 * constructor
	 */
	public MyActionListenertest(PrintStream pp, Scanner s, JTextArea texxt, JTextField tf, client app) {
		p = pp;
		sc = s;
		text = texxt;
		textField = tf;
